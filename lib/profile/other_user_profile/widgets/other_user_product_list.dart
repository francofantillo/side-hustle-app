...
class OtherProductsListShop extends StatefulWidget {

  const OtherProductsListShop({super.key});

  @override
  State<OtherProductsListShop> createState() => _OtherProductsListShopState();
}

class _OtherProductsListShopState extends State<OtherProductsListShop> {
  @override
