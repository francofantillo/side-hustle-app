class AssetsPath {
  ...
  /// Alpha
  static const alphaPath = "assets/images/alpha/";
  ...
  static const eyeClosed = "${iconsPath}eye_closed.png";
  static const favourite = "${iconsPath}fav.png";
  static const logout = "${iconsPath}logout.png";
  static const pp = "${iconsPath}pp.png";
  static const list = "${iconsPath}list.png";
  static const aboutUs = "${iconsPath}about_us.png";
