        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: ProductCartItemWidget(
              ...
              title: AlphaAppData.sideHustleProductsList[0].title,
              subTitle: AlphaAppData.sideHustleProductsList[0].subTitle,
              imagePath: AlphaAppData.sideHustleProductsList[0].imagePath,
              price: AlphaAppData.sideHustleProductsList[0].price,
              onTap: () {},
            ),
          );
        },
