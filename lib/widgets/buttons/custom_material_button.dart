...
Widget customMaterialButton({String? name,
  Color? color,
  double? width,
  double? height,
...
class CustomMaterialButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialButton(
      ...
      elevation: AppDimensions.defaultButtonElevation, // what are the Google Material Design guidelines text field, buttons and appBar elevation
