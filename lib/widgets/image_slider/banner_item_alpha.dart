...
class BannerItemAlpha extends StatefulWidget {
  ...
  @override
  State<BannerItemAlpha> createState() => _BannerItemAlphaState();
}

class _BannerItemAlphaState extends State<BannerItemAlpha> {
  bool isLoading = true;
