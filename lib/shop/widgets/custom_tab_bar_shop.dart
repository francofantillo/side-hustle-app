...
class CustomTabBarShop extends StatefulWidget {
  final List<String> tabNames;
  final int currentTabIndex;
  final ValueChanged<int> onChanged;

  const CustomTabBarShop(
      {super.key,
  ...
  @override
  State<CustomTabBarShop> createState() => _CustomTabBarShopState();
}

class _CustomTabBarShopState extends State<CustomTabBarShop> {
